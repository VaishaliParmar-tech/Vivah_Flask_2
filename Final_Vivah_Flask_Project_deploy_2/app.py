...
MAIL_SENDER_EMAIL = os.environ.get('MAIL_SENDER_EMAIL', '')  # Replace with your Gmail
MAIL_SENDER_PASSWORD = os.environ.get('MAIL_SENDER_PASSWORD', '')  # Use Gmail App Password
